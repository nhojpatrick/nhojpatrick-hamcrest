...
public class IsAfterDateTime_ZonedDateTimeTest {
    ...
    @DisplayName("ZonedDateTime after(CompareType,RoundingType) exceptions")
    public <T extends Throwable> void CompareType_RoundingType_exceptions(final Class<T> exception,
        ...
        final Executable testMethod = () -> afterZonedDateTime(expected, compareType, coundingType);
        final T thrown = assertThrows(exception, testMethod);
        assertAll(
                () -> assertThat(thrown.getMessage(), is(equalTo(msg))),
                () -> assertThat(thrown.getCause(), is(nullValue()))
    ...
    @TestFactory
    @DisplayName("ZonedDateTime after(CompareType,RoundingType) tests")
    public Stream<DynamicTest> CompareType_RoundingType_tests() {

        return Stream.of(
                // after
                dynamicTest("Actual is after After(EXCLUSIVE,DOWN)", () -> TESTER.assertValid(NOW, afterZonedDateTime(PAST, EXCLUSIVE, DOWN))),
                dynamicTest("Actual is after After(EXCLUSIVE,NONE)", () -> TESTER.assertValid(NOW, afterZonedDateTime(PAST, EXCLUSIVE, NONE))),
                dynamicTest("Actual is after After(EXCLUSIVE,UP)", () -> TESTER.assertValid(NOW, afterZonedDateTime(PAST, EXCLUSIVE, UP))),
                dynamicTest("Actual is after After(INCLUSIVE,DOWN)", () -> TESTER.assertValid(NOW, afterZonedDateTime(PAST, INCLUSIVE, DOWN))),
                dynamicTest("Actual is after After(INCLUSIVE,NONE)", () -> TESTER.assertValid(NOW, afterZonedDateTime(PAST, INCLUSIVE, NONE))),
                dynamicTest("Actual is after After(INCLUSIVE,UP)", () -> TESTER.assertValid(NOW, afterZonedDateTime(PAST, INCLUSIVE, UP))),

                // before
                dynamicTest("Actual is before After(EXCLUSIVE,DOWN)", () -> TESTER.assertFails(NOW, afterZonedDateTime(FUTURE, EXCLUSIVE, DOWN), String.format("\nExpected: after <%s>\n      but: was <%s>", FUTURE.withNano(0), NOW))),
                dynamicTest("Actual is before After(EXCLUSIVE,NONE)", () -> TESTER.assertFails(NOW, afterZonedDateTime(FUTURE, EXCLUSIVE, NONE), String.format("\nExpected: after <%s>\n      but: was <%s>", FUTURE, NOW))), dynamicTest("Actual is after After(EXCLUSIVE,UP)", () -> TESTER.assertFails(NOW, afterZonedDateTime(FUTURE, EXCLUSIVE, UP), String.format("\nExpected: after <%s>\n      but: was <%s>", FUTURE.withNano(999_999_999), NOW))),
                dynamicTest("Actual is before After(INCLUSIVE,DOWN)", () -> TESTER.assertFails(NOW, afterZonedDateTime(FUTURE, INCLUSIVE, DOWN), String.format("\nExpected: after or equal to <%s>\n      but: was <%s>", FUTURE.withNano(0), NOW))),
                dynamicTest("Actual is before After(INCLUSIVE,NONE)", () -> TESTER.assertFails(NOW, afterZonedDateTime(FUTURE, INCLUSIVE, NONE), String.format("\nExpected: after or equal to <%s>\n      but: was <%s>", FUTURE, NOW))),
                dynamicTest("Actual is before After(INCLUSIVE,UP)", () -> TESTER.assertFails(NOW, afterZonedDateTime(FUTURE, INCLUSIVE, UP), String.format("\nExpected: after or equal to <%s>\n      but: was <%s>", FUTURE.withNano(999_999_999), NOW))),

                // boundary
                dynamicTest("Actual is After(EXCLUSIVE,DOWN)", () -> TESTER.assertValid(NOW, afterZonedDateTime(NOW, EXCLUSIVE, DOWN))),
                dynamicTest("Actual is After(EXCLUSIVE,NONE)", () -> TESTER.assertFails(NOW, afterZonedDateTime(NOW, EXCLUSIVE, NONE), String.format("\nExpected: after <%s>\n      but: was <%s>", NOW, NOW))),
                dynamicTest("Actual is After(EXCLUSIVE,UP)", () -> TESTER.assertFails(NOW, afterZonedDateTime(NOW, EXCLUSIVE, UP), String.format("\nExpected: after <%s>\n      but: was <%s>", NOW.withNano(999_999_999), NOW))),
                dynamicTest("Actual is After(INCLUSIVE,DOWN)", () -> TESTER.assertValid(NOW, afterZonedDateTime(NOW, INCLUSIVE, DOWN))),
                dynamicTest("Actual is After(INCLUSIVE,NONE)", () -> TESTER.assertValid(NOW, afterZonedDateTime(NOW, INCLUSIVE, NONE))),
                dynamicTest("Actual is After(INCLUSIVE,UP)", () -> TESTER.assertFails(NOW, afterZonedDateTime(NOW, INCLUSIVE, UP), String.format("\nExpected: after or equal to <%s>\n      but: was <%s>", NOW.withNano(999_999_999), NOW)))
        );
    }

    @ParameterizedTest
    @MethodSource("RoundingType_exceptionSource")
    @DisplayName("ZonedDateTime after(RoundingType) exceptions")
    public <T extends Throwable> void RoundingType_exceptions(final Class<T> exception,
                                                              final ZonedDateTime expected,
                                                              final RoundingType roundingType,
                                                              final String msg) {

        final Executable testMethod = () -> afterZonedDateTime(expected, roundingType);
        final T thrown = assertThrows(exception, testMethod);
        assertAll(
                () -> assertThat(thrown.getMessage(), is(equalTo(msg))),
                () -> assertThat(thrown.getCause(), is(nullValue()))
    ...
    @TestFactory
    @DisplayName("ZonedDateTime after(RoundingType) tests")
    public Stream<DynamicTest> RoundingType_tests() {

        return Stream.of(
                //after
                dynamicTest("Actual is after After(DOWN)", () -> TESTER.assertValid(NOW, afterZonedDateTime(PAST, DOWN))),
                dynamicTest("Actual is after After(NONE)", () -> TESTER.assertValid(NOW, afterZonedDateTime(PAST, NONE))),
                dynamicTest("Actual is after After(UP)", () -> TESTER.assertValid(NOW, afterZonedDateTime(PAST, UP))),

                // before
                dynamicTest("Actual is before After(DOWN)", () -> TESTER.assertFails(NOW, afterZonedDateTime(FUTURE, DOWN), String.format("\nExpected: after <%s>\n      but: was <%s>", FUTURE.withNano(0), NOW))),
                dynamicTest("Actual is before After(NONE)", () -> TESTER.assertFails(NOW, afterZonedDateTime(FUTURE, NONE), String.format("\nExpected: after <%s>\n      but: was <%s>", FUTURE, NOW))),
                dynamicTest("Actual is before After(UP)", () -> TESTER.assertFails(NOW, afterZonedDateTime(FUTURE, UP), String.format("\nExpected: after <%s>\n      but: was <%s>", FUTURE.withNano(999_999_999), NOW))),

                // boundary
                dynamicTest("Actual is After(DOWN)", () -> TESTER.assertValid(NOW, afterZonedDateTime(NOW, DOWN))),
                dynamicTest("Actual is After(NONE)", () -> TESTER.assertFails(NOW, afterZonedDateTime(NOW, NONE), String.format("\nExpected: after <%s>\n      but: was <%s>", NOW, NOW))),
                dynamicTest("Actual is After(UP)", () -> TESTER.assertFails(NOW, afterZonedDateTime(NOW, UP), String.format("\nExpected: after <%s>\n      but: was <%s>", NOW.withNano(999_999_999), NOW)))
        );
    }

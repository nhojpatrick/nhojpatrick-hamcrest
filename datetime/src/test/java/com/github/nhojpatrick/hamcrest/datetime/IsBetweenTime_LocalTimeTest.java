...
public class IsBetweenTime_LocalTimeTest {
    ...
    @DisplayName("LocalTime between(CompareType,RoundingType) exceptions")
    public <T extends Throwable> void CompareType_RoundingType_exceptions(final Class<T> exception,
        ...
        final Executable testMethod = () -> betweenLocalTime(after, afterCompareType, afterRoundingType, before, beforeCompareType, beforeRoundingType);
        final T thrown = assertThrows(exception, testMethod);
        assertAll(
                () -> assertThat(thrown.getMessage(), is(equalTo(msg))),
                () -> assertThat(thrown.getCause(), is(nullValue()))
    ...
    public Stream<DynamicTest> CompareType_RoundingType_tests() {
        ...
        return Stream.of(
                // Within Boundary
                dynamicTest("Actual is between After(EXCLUSIVE,DOWN) and Before(EXCLUSIVE,DOWN)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, EXCLUSIVE, DOWN, FUTURE, EXCLUSIVE, DOWN))),
                dynamicTest("Actual is between After(EXCLUSIVE,NONE) and Before(EXCLUSIVE,NONE)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, EXCLUSIVE, NONE, FUTURE, EXCLUSIVE, NONE))),
                dynamicTest("Actual is between After(EXCLUSIVE,UP) and Before(EXCLUSIVE,UP)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, EXCLUSIVE, UP, FUTURE, EXCLUSIVE, UP))),
                dynamicTest("Actual is between After(EXCLUSIVE,DOWN) and Before(INCLUSIVE,DOWN)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, EXCLUSIVE, DOWN, FUTURE, INCLUSIVE, DOWN))),
                dynamicTest("Actual is between After(EXCLUSIVE,NONE) and Before(INCLUSIVE,NONE)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, EXCLUSIVE, NONE, FUTURE, INCLUSIVE, NONE))),
                dynamicTest("Actual is between After(EXCLUSIVE,UP) and Before(INCLUSIVE,UP)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, EXCLUSIVE, UP, FUTURE, INCLUSIVE, UP))),
                dynamicTest("Actual is between After(INCLUSIVE,DOWN) and Before(EXCLUSIVE,DOWN)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, INCLUSIVE, DOWN, FUTURE, EXCLUSIVE, DOWN))),
                dynamicTest("Actual is between After(INCLUSIVE,NONE) and Before(EXCLUSIVE,NONE)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, INCLUSIVE, NONE, FUTURE, EXCLUSIVE, NONE))),
                dynamicTest("Actual is between After(INCLUSIVE,UP) and Before(EXCLUSIVE,UP)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, INCLUSIVE, UP, FUTURE, EXCLUSIVE, UP))),
                dynamicTest("Actual is between After(INCLUSIVE,DOWN) and Before(INCLUSIVE,DOWN)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, INCLUSIVE, DOWN, FUTURE, INCLUSIVE, DOWN))),
                dynamicTest("Actual is between After(INCLUSIVE,NONE) and Before(INCLUSIVE,NONE)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, INCLUSIVE, NONE, FUTURE, INCLUSIVE, NONE))),
                dynamicTest("Actual is between After(INCLUSIVE,UP) and Before(INCLUSIVE,UP)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, INCLUSIVE, UP, FUTURE, INCLUSIVE, UP))),
                dynamicTest("Actual is between After(INCLUSIVE,DOWN) and Before(INCLUSIVE,DOWN)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, INCLUSIVE, DOWN, FUTURE, INCLUSIVE, DOWN))),
                dynamicTest("Actual is between After(INCLUSIVE,NONE) and Before(INCLUSIVE,NONE)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, INCLUSIVE, NONE, FUTURE, INCLUSIVE, NONE))),
                dynamicTest("Actual is between After(INCLUSIVE,UP) and Before(INCLUSIVE,UP)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, INCLUSIVE, UP, FUTURE, INCLUSIVE, UP))),

                // before after
                dynamicTest("Actual is before After(EXCLUSIVE,DOWN) value with Before(EXCLUSIVE,DOWN)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, EXCLUSIVE, DOWN, FUTURE, EXCLUSIVE, DOWN), String.format("\nExpected: (after <%s> and before <%s>)\n      but: after <%s> was <%s>", NOW.withNano(0), FUTURE.withNano(0), NOW.withNano(0), PAST))),
                dynamicTest("Actual is before After(EXCLUSIVE,NONE) value with Before(EXCLUSIVE,NONE)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, EXCLUSIVE, NONE, FUTURE, EXCLUSIVE, NONE), String.format("\nExpected: (after <%s> and before <%s>)\n      but: after <%s> was <%s>", NOW, FUTURE, NOW, PAST))),
                dynamicTest("Actual is before After(EXCLUSIVE,UP) value with Before(EXCLUSIVE,UP)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, EXCLUSIVE, UP, FUTURE, EXCLUSIVE, UP), String.format("\nExpected: (after <%s> and before <%s>)\n      but: after <%s> was <%s>", NOW.withNano(999_999_999), FUTURE.withNano(999_999_999), NOW.withNano(999_999_999), PAST))),
                dynamicTest("Actual is before After(EXCLUSIVE,DOWN) value with Before(INCLUSIVE,DOWN)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, EXCLUSIVE, DOWN, FUTURE, INCLUSIVE, DOWN), String.format("\nExpected: (after <%s> and before or equal to <%s>)\n      but: after <%s> was <%s>", NOW.withNano(0), FUTURE.withNano(0), NOW.withNano(0), PAST))),
                dynamicTest("Actual is before After(EXCLUSIVE,NONE) value with Before(INCLUSIVE,NONE)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, EXCLUSIVE, NONE, FUTURE, INCLUSIVE, NONE), String.format("\nExpected: (after <%s> and before or equal to <%s>)\n      but: after <%s> was <%s>", NOW, FUTURE, NOW, PAST))),
                dynamicTest("Actual is before After(EXCLUSIVE,UP) value with Before(INCLUSIVE,UP)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, EXCLUSIVE, UP, FUTURE, INCLUSIVE, UP), String.format("\nExpected: (after <%s> and before or equal to <%s>)\n      but: after <%s> was <%s>", NOW.withNano(999_999_999), FUTURE.withNano(999_999_999), NOW.withNano(999_999_999), PAST))),
                dynamicTest("Actual is before After(INCLUSIVE,DOWN) value with Before(EXCLUSIVE,DOWN)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, INCLUSIVE, DOWN, FUTURE, EXCLUSIVE, DOWN), String.format("\nExpected: (after or equal to <%s> and before <%s>)\n      but: after or equal to <%s> was <%s>", NOW.withNano(0), FUTURE.withNano(0), NOW.withNano(0), PAST))),
                dynamicTest("Actual is before After(INCLUSIVE,NONE) value with Before(EXCLUSIVE,NONE)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, INCLUSIVE, NONE, FUTURE, EXCLUSIVE, NONE), String.format("\nExpected: (after or equal to <%s> and before <%s>)\n      but: after or equal to <%s> was <%s>", NOW, FUTURE, NOW, PAST))),
                dynamicTest("Actual is before After(INCLUSIVE,UP) value with Before(INCLUSIVE,UP)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, INCLUSIVE, UP, FUTURE, INCLUSIVE, UP), String.format("\nExpected: (after or equal to <%s> and before or equal to <%s>)\n      but: after or equal to <%s> was <%s>", NOW.withNano(999_999_999), FUTURE.withNano(999_999_999), NOW.withNano(999_999_999), PAST))),

                // after before
                dynamicTest("Actual is after Before(EXCLUSIVE,DOWN) value with After(EXCLUSIVE,DOWN)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, DOWN, NOW, EXCLUSIVE, DOWN), String.format("\nExpected: (after <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST.withNano(0), NOW.withNano(0), NOW.withNano(0), FUTURE))),
                dynamicTest("Actual is after Before(EXCLUSIVE,NONE) value with After(EXCLUSIVE,NONE)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, NONE, NOW, EXCLUSIVE, NONE), String.format("\nExpected: (after <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST, NOW, NOW, FUTURE))),
                dynamicTest("Actual is after Before(EXCLUSIVE,UP) value with After(EXCLUSIVE,UP)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, UP, NOW, EXCLUSIVE, UP), String.format("\nExpected: (after <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST.withNano(999_999_999), NOW.withNano(999_999_999), NOW.withNano(999_999_999), FUTURE))),
                dynamicTest("Actual is after Before(INCLUSIVE,DOWN) value with After(EXCLUSIVE,DOWN)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, DOWN, NOW, INCLUSIVE, DOWN), String.format("\nExpected: (after <%s> and before or equal to <%s>)\n      but: before or equal to <%s> was <%s>", PAST.withNano(0), NOW.withNano(0), NOW.withNano(0), FUTURE))),
                dynamicTest("Actual is after Before(INCLUSIVE,NONE) value with After(EXCLUSIVE,NONE)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, NONE, NOW, INCLUSIVE, NONE), String.format("\nExpected: (after <%s> and before or equal to <%s>)\n      but: before or equal to <%s> was <%s>", PAST, NOW, NOW, FUTURE))),
                dynamicTest("Actual is after Before(INCLUSIVE,UP) value with After(EXCLUSIVE,UP)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, UP, NOW, INCLUSIVE, UP), String.format("\nExpected: (after <%s> and before or equal to <%s>)\n      but: before or equal to <%s> was <%s>", PAST.withNano(999_999_999), NOW.withNano(999_999_999), NOW.withNano(999_999_999), FUTURE))),
                dynamicTest("Actual is after Before(EXCLUSIVE,DOWN) value with After(INCLUSIVE,DOWN)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, INCLUSIVE, DOWN, NOW, EXCLUSIVE, DOWN), String.format("\nExpected: (after or equal to <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST.withNano(0), NOW.withNano(0), NOW.withNano(0), FUTURE))),
                dynamicTest("Actual is after Before(EXCLUSIVE,NONE) value with After(INCLUSIVE,NONE)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, INCLUSIVE, NONE, NOW, EXCLUSIVE, NONE), String.format("\nExpected: (after or equal to <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST, NOW, NOW, FUTURE))),
                dynamicTest("Actual is after Before(EXCLUSIVE,UP) value with After(INCLUSIVE,UP)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, INCLUSIVE, UP, NOW, EXCLUSIVE, UP), String.format("\nExpected: (after or equal to <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST.withNano(999_999_999), NOW.withNano(999_999_999), NOW.withNano(999_999_999), FUTURE))),
                dynamicTest("Actual is after Before(INCLUSIVE,DOWN) value with After(INCLUSIVE,DOWN)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, INCLUSIVE, DOWN, NOW, INCLUSIVE, DOWN), String.format("\nExpected: (after or equal to <%s> and before or equal to <%s>)\n      but: before or equal to <%s> was <%s>", PAST.withNano(0), NOW.withNano(0), NOW.withNano(0), FUTURE))),
                dynamicTest("Actual is after Before(INCLUSIVE,NONE) value with After(INCLUSIVE,NONE)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, INCLUSIVE, NONE, NOW, INCLUSIVE, NONE), String.format("\nExpected: (after or equal to <%s> and before or equal to <%s>)\n      but: before or equal to <%s> was <%s>", PAST, NOW, NOW, FUTURE))),
                dynamicTest("Actual is after Before(INCLUSIVE,UP) value with After(INCLUSIVE,UP)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, INCLUSIVE, UP, NOW, INCLUSIVE, UP), String.format("\nExpected: (after or equal to <%s> and before or equal to <%s>)\n      but: before or equal to <%s> was <%s>", PAST.withNano(999_999_999), NOW.withNano(999_999_999), NOW.withNano(999_999_999), FUTURE))),

                // After Boundary
                dynamicTest("Actual is After(EXCLUSIVE,DOWN) and Before(EXCLUSIVE,DOWN)", () -> TESTER.assertValid(PAST, betweenLocalTime(PAST, EXCLUSIVE, DOWN, FUTURE, EXCLUSIVE, DOWN))),
                dynamicTest("Actual is After(EXCLUSIVE,DOWN) and Before(INCLUSIVE,DOWN)", () -> TESTER.assertValid(PAST, betweenLocalTime(PAST, EXCLUSIVE, DOWN, FUTURE, INCLUSIVE, DOWN))),
                dynamicTest("Actual is After(EXCLUSIVE,NONE) and Before(EXCLUSIVE,NONE)", () -> TESTER.assertFails(PAST, betweenLocalTime(PAST, EXCLUSIVE, NONE, FUTURE, EXCLUSIVE, NONE), String.format("\nExpected: (after <%s> and before <%s>)\n      but: after <%s> was <%s>", PAST, FUTURE, PAST, PAST))),
                dynamicTest("Actual is After(EXCLUSIVE,NONE) and Before(INCLUSIVE,NONE)", () -> TESTER.assertFails(PAST, betweenLocalTime(PAST, EXCLUSIVE, NONE, FUTURE, INCLUSIVE, NONE), String.format("\nExpected: (after <%s> and before or equal to <%s>)\n      but: after <%s> was <%s>", PAST, FUTURE, PAST, PAST))),
                dynamicTest("Actual is After(EXCLUSIVE,UP) and Before(EXCLUSIVE,UP)", () -> TESTER.assertFails(PAST, betweenLocalTime(PAST, EXCLUSIVE, UP, FUTURE, EXCLUSIVE, UP), String.format("\nExpected: (after <%s> and before <%s>)\n      but: after <%s> was <%s>", PAST.withNano(999_999_999), FUTURE.withNano(999_999_999), PAST.withNano(999_999_999), PAST))),
                dynamicTest("Actual is After(EXCLUSIVE,UP) and Before(INCLUSIVE,UP)", () -> TESTER.assertFails(PAST, betweenLocalTime(PAST, EXCLUSIVE, UP, FUTURE, INCLUSIVE, UP), String.format("\nExpected: (after <%s> and before or equal to <%s>)\n      but: after <%s> was <%s>", PAST.withNano(999_999_999), FUTURE.withNano(999_999_999), PAST.withNano(999_999_999), PAST))),
                dynamicTest("Actual is After(INCLUSIVE,DOWN) and Before(EXCLUSIVE,DOWN)", () -> TESTER.assertValid(PAST, betweenLocalTime(PAST, INCLUSIVE, DOWN, FUTURE, EXCLUSIVE, DOWN))),
                dynamicTest("Actual is After(INCLUSIVE,DOWN) and Before(INCLUSIVE,DOWN)", () -> TESTER.assertValid(PAST, betweenLocalTime(PAST, INCLUSIVE, DOWN, FUTURE, INCLUSIVE, DOWN))),
                dynamicTest("Actual is After(INCLUSIVE,NONE) and Before(EXCLUSIVE,NONE)", () -> TESTER.assertValid(PAST, betweenLocalTime(PAST, INCLUSIVE, NONE, FUTURE, EXCLUSIVE, NONE))),
                dynamicTest("Actual is After(INCLUSIVE,NONE) and Before(INCLUSIVE,NONE)", () -> TESTER.assertValid(PAST, betweenLocalTime(PAST, INCLUSIVE, NONE, FUTURE, INCLUSIVE, NONE))),
                dynamicTest("Actual is After(INCLUSIVE,UP) and Before(EXCLUSIVE,UP)", () -> TESTER.assertFails(PAST, betweenLocalTime(PAST, INCLUSIVE, UP, FUTURE, EXCLUSIVE, UP), String.format("\nExpected: (after or equal to <%s> and before <%s>)\n      but: after or equal to <%s> was <%s>", PAST.withNano(999_999_999), FUTURE.withNano(999_999_999), PAST.withNano(999_999_999), PAST))),
                dynamicTest("Actual is After(INCLUSIVE,UP) and Before(INCLUSIVE,UP)", () -> TESTER.assertFails(PAST, betweenLocalTime(PAST, INCLUSIVE, UP, FUTURE, INCLUSIVE, UP), String.format("\nExpected: (after or equal to <%s> and before or equal to <%s>)\n      but: after or equal to <%s> was <%s>", PAST.withNano(999_999_999), FUTURE.withNano(999_999_999), PAST.withNano(999_999_999), PAST))),

                // Before Boundary
                dynamicTest("Actual is Before(EXCLUSIVE,DOWN) and After(EXCLUSIVE,DOWN)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, DOWN, FUTURE, EXCLUSIVE, DOWN), String.format("\nExpected: (after <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST.withNano(0), FUTURE.withNano(0), FUTURE.withNano(0), FUTURE))),
                dynamicTest("Actual is Before(EXCLUSIVE,DOWN) and After(INCLUSIVE,DOWN)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, INCLUSIVE, DOWN, FUTURE, EXCLUSIVE, DOWN), String.format("\nExpected: (after or equal to <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST.withNano(0), FUTURE.withNano(0), FUTURE.withNano(0), FUTURE))),
                dynamicTest("Actual is Before(EXCLUSIVE,NONE) and After(EXCLUSIVE,NONE)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, NONE, FUTURE, EXCLUSIVE, NONE), String.format("\nExpected: (after <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST, FUTURE, FUTURE, FUTURE))),
                dynamicTest("Actual is Before(EXCLUSIVE,NONE) and After(INCLUSIVE,NONE)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, INCLUSIVE, NONE, FUTURE, EXCLUSIVE, NONE), String.format("\nExpected: (after or equal to <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST, FUTURE, FUTURE, FUTURE))),
                dynamicTest("Actual is Before(EXCLUSIVE,UP) and After(EXCLUSIVE,UP)", () -> TESTER.assertValid(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, UP, FUTURE, EXCLUSIVE, UP))),
                dynamicTest("Actual is Before(EXCLUSIVE,UP) and After(INCLUSIVE,UP)", () -> TESTER.assertValid(FUTURE, betweenLocalTime(PAST, INCLUSIVE, UP, FUTURE, EXCLUSIVE, UP))),
                dynamicTest("Actual is Before(INCLUSIVE,DOWN) and After(EXCLUSIVE,DOWN)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, DOWN, FUTURE, INCLUSIVE, DOWN), String.format("\nExpected: (after <%s> and before or equal to <%s>)\n      but: before or equal to <%s> was <%s>", PAST.withNano(0), FUTURE.withNano(0), FUTURE.withNano(0), FUTURE))),
                dynamicTest("Actual is Before(INCLUSIVE,DOWN) and After(INCLUSIVE,DOWN)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, INCLUSIVE, DOWN, FUTURE, INCLUSIVE, DOWN), String.format("\nExpected: (after or equal to <%s> and before or equal to <%s>)\n      but: before or equal to <%s> was <%s>", PAST.withNano(0), FUTURE.withNano(0), FUTURE.withNano(0), FUTURE))),
                dynamicTest("Actual is Before(INCLUSIVE,NONE) and After(EXCLUSIVE,NONE)", () -> TESTER.assertValid(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, NONE, FUTURE, INCLUSIVE, NONE))),
                dynamicTest("Actual is Before(INCLUSIVE,NONE) and After(INCLUSIVE,NONE)", () -> TESTER.assertValid(FUTURE, betweenLocalTime(PAST, INCLUSIVE, NONE, FUTURE, INCLUSIVE, NONE))),
                dynamicTest("Actual is Before(INCLUSIVE,UP) and After(EXCLUSIVE,UP)", () -> TESTER.assertValid(FUTURE, betweenLocalTime(PAST, EXCLUSIVE, UP, FUTURE, INCLUSIVE, UP))),
                dynamicTest("Actual is Before(INCLUSIVE,UP) and After(INCLUSIVE,UP)", () -> TESTER.assertValid(FUTURE, betweenLocalTime(PAST, INCLUSIVE, UP, FUTURE, INCLUSIVE, UP)))
        );
    }

    @ParameterizedTest
    @MethodSource("RoundingType_exceptionSource")
    @DisplayName("LocalTime between(RoundingType) exceptions")
    public <T extends Throwable> void RoundingType_exceptions(final Class<T> exception,
        ...
        final Executable testMethod = () -> betweenLocalTime(after, afterRoundingType, before, beforeRoundingType);
        final T thrown = assertThrows(exception, testMethod);
        assertAll(
                () -> assertThat(thrown.getMessage(), is(equalTo(msg))),
                () -> assertThat(thrown.getCause(), is(nullValue()))
    ...
    public Stream<DynamicTest> RoundingType_tests() {
        ...
        return Stream.of(
                // Within Boundary
                dynamicTest("Actual is between After(DOWN) and Before(DOWN)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, DOWN, FUTURE, DOWN))),
                dynamicTest("Actual is between After(NONE) and Before(NONE)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, NONE, FUTURE, NONE))),
                dynamicTest("Actual is between After(UP) and Before(UP)", () -> TESTER.assertValid(NOW, betweenLocalTime(PAST, UP, FUTURE, UP))),

                // before after
                dynamicTest("Actual is before After(DOWN) value with Before(DOWN)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, DOWN, FUTURE, DOWN), String.format("\nExpected: (after <%s> and before <%s>)\n      but: after <%s> was <%s>", NOW.withNano(0), FUTURE.withNano(0), NOW.withNano(0), PAST))),
                dynamicTest("Actual is before After(NONE) value with Before(NONE)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, NONE, FUTURE, NONE), String.format("\nExpected: (after <%s> and before <%s>)\n      but: after <%s> was <%s>", NOW, FUTURE, NOW, PAST))),
                dynamicTest("Actual is before After(UP) value with Before(UP)", () -> TESTER.assertFails(PAST, betweenLocalTime(NOW, UP, FUTURE, UP), String.format("\nExpected: (after <%s> and before <%s>)\n      but: after <%s> was <%s>", NOW.withNano(999_999_999), FUTURE.withNano(999_999_999), NOW.withNano(999_999_999), PAST))),

                // after before
                dynamicTest("Actual is after Before(DOWN) value with After(DOWN)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, DOWN, NOW, DOWN), String.format("\nExpected: (after <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST.withNano(0), NOW.withNano(0), NOW.withNano(0), FUTURE))),
                dynamicTest("Actual is after Before(NONE) value with After(NONE)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, NONE, NOW, NONE), String.format("\nExpected: (after <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST, NOW, NOW, FUTURE))),
                dynamicTest("Actual is after Before(UP) value with After(UP)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, UP, NOW, UP), String.format("\nExpected: (after <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST.withNano(999_999_999), NOW.withNano(999_999_999), NOW.withNano(999_999_999), FUTURE))),

                // After Boundary
                dynamicTest("Actual is After(DOWN) and Before(DOWN)", () -> TESTER.assertValid(PAST, betweenLocalTime(PAST, DOWN, FUTURE, DOWN))),
                dynamicTest("Actual is After(NONE) and Before(NONE)", () -> TESTER.assertFails(PAST, betweenLocalTime(PAST, NONE, FUTURE, NONE), String.format("\nExpected: (after <%s> and before <%s>)\n      but: after <%s> was <%s>", PAST, FUTURE, PAST, PAST))),
                dynamicTest("Actual is After(UP) and Before(UP)", () -> TESTER.assertFails(PAST, betweenLocalTime(PAST, UP, FUTURE, UP), String.format("\nExpected: (after <%s> and before <%s>)\n      but: after <%s> was <%s>", PAST.withNano(999_999_999), FUTURE.withNano(999_999_999), PAST.withNano(999_999_999), PAST))),

                // Before Boundary
                dynamicTest("Actual is Before(DOWN) and After(DOWN)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, DOWN, FUTURE, DOWN), String.format("\nExpected: (after <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST.withNano(0), FUTURE.withNano(0), FUTURE.withNano(0), FUTURE))),
                dynamicTest("Actual is Before(NONE) and After(NONE)", () -> TESTER.assertFails(FUTURE, betweenLocalTime(PAST, NONE, FUTURE, NONE), String.format("\nExpected: (after <%s> and before <%s>)\n      but: before <%s> was <%s>", PAST, FUTURE, FUTURE, FUTURE))),
                dynamicTest("Actual is Before(UP) and After(UP)", () -> TESTER.assertValid(FUTURE, betweenLocalTime(PAST, UP, FUTURE, UP)))
        );
    }
